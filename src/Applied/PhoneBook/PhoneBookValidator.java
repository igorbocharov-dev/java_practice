...
public final class PhoneBookValidator {
    ...
    public static void checkName(String name, Map<String, Set<Long>> phoneBook){
        if(!phoneBook.containsKey(name)){
            throw new IllegalArgumentException("Такого имени нет в телефонной книге");
        }
    }

    public static void checkNumber(String name, Long number, Map<String, Set<Long>> phoneBook){
